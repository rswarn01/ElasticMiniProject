...
class SearchDocs(Resource):
    def get(self):
        ...
        parser.add_argument(
            "searching_data", type=str, location="args"
        )
...
class UpdateDocument(Resource):
    def post(self):
        parser = reqparse.RequestParser()
        parser.add_argument(
            "searching_data", type=str, location="form"
        )
        args = parser.parse_args()
...
class UpdateDbandSyncElastic(Resource):
    def post(self):
        parser = reqparse.RequestParser()
        parser.add_argument(
            "supplier_metadata_id", type=int, location="form"
        )
        parser.add_argument(
            "supplier_id", type=int, location="form"
        )
        parser.add_argument(
            "supplier_name", type=str, location="form"
        )
        parser.add_argument(
            "new_value", type=str, location="form"
        )
        args = parser.parse_args()
